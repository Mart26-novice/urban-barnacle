...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println("\r\n[Terms and Agreement: I agree to share my personal information and\n"
						+ "provide valid data for the said transaction. TECHNUH IMPACT BAZAAR\n"
						+ "respect, secure, and provide data privacy to our beloved customers.]\r\n");
